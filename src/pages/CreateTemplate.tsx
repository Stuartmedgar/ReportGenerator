          ...
          <div style={{
            ...
            {sections.map((section, index) => (
              <div key={section.id} style={{
                ...
                {/* Section Header - FIXED TITLE HIERARCHY */}
                <div style={{ 
                  display: 'flex', 
                  ...
                  <div>
                    ...
                    <h3 style={{ 
                      ...
                      {index + 1}. {section.data?.name || getSectionDisplayName(section.type)}
                    </h3>
                    {/* Section Type - small subtitle */}
                    {section.data?.name && (
                      <p style={{
                        fontSize: '14px',
                        fontWeight: '400',
                ...
                {section.type === 'rated-comment' && section.data ? (
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <textarea
                        value={section.data?.content || '[Name] has made steady progress throughout this term.'}
                        style={{
                          width: '100%',
                          padding: '12px',
                      ...
                      <p style={{
                        ...
                        Teachers can edit this text. Use [Name] for student's first name.
                      </p>
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{ marginBottom: '8px' }}>
                        <label style={{ fontSize: '14px', color: '#374151', marginRight: '16px' }}>
                          <input type="radio" disabled style={{ marginRight: '4px' }} />
                          Score out of total
                        </label>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        />
                        <span style={{ fontSize: '14px' }}>out of</span>
                        <input
                          type="number"
                          placeholder="Total"
                          disabled
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                        {['Excellent', 'Good', 'Satisfactory', 'Needs Improvement', 'Not Completed', 'No Comment'].map(level => (
                          <label key={level} style={{ fontSize: '13px', color: '#374151' }}>
                            <input type="radio" disabled style={{ marginRight: '4px' }} />
                            {level}
                          </label>
                        ))}
